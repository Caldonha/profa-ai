...
<head>
    ...
    <style>
        ...
        .register-icon-circle {
            ...
            background: linear-gradient(135deg, #818cf8 60%, #7c3aed 100%);
            border-radius: 50%;
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center min-vh-100">
        <div class="register-card mx-auto">
            <div class="register-icon-circle"><i class="bi bi-person-plus"></i></div>
            <div class="text-center mb-2">
                <div class="register-title">Crie sua conta</div>
                <div class="welcome-text">Preencha os campos para se cadastrar no PROFA.AI</div>
            </div>
            <form action="{{ route('register') }}" method="POST">
                @csrf
                <div class="mb-3 input-group">
                    <span class="input-group-text"><i class="bi bi-person"></i></span>
                    <input id="name" name="name" type="text" required class="form-control" placeholder="Nome">
                </div>
                <div class="mb-3 input-group">
                ...
                <div class="mb-3 input-group">
                    ...
                    <input id="password_confirmation" name="password_confirmation" type="password" required class="form-control" placeholder="Confirmar Senha">
                </div>
                @if ($errors->any())
                ...
                @endif
                <button type="submit" class="btn register-btn w-100 mb-2 py-2">Registrar</button>
